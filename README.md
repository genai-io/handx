...
<p align="center">
  <img src="docs/screenshots/terminal-live.jpg" alt="Live Terminal — real-time tmux interaction" width="300" />
  &nbsp;&nbsp;&nbsp;&nbsp;
  <img src="docs/screenshots/home-sessions.jpg" alt="Session List — manage all tmux sessions" width="300" />
</p>
<p align="center">
  <em>Left: Live terminal with real-time output &nbsp;|&nbsp; Right: Session list with connection status</em>
</p>
